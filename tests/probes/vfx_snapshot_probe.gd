...
func _run_probe() -> void:
	...
	BattleVfxRef.spawn_fireball_burst(canvas, Vector2(180.0, 200.0), Color(1.0, 0.52, 0.24, 1.0), 58.0)
	BattleVfxRef.spawn_dust_cloud(canvas, Vector2(340.0, 200.0), 40.0)
	BattleVfxRef.spawn_lightning_strike(canvas, Vector2(430.0, 90.0), Vector2(470.0, 170.0), Vector2(520.0, 250.0), 1, 0)
