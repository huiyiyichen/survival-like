...
func _run_probe() -> void:
	...
	BattleVfx.spawn_fireball_burst(root_node, Vector2(120.0, 80.0), Color(1.0, 0.52, 0.24, 1.0), 52.0)
	BattleVfx.spawn_dust_cloud(root_node, Vector2(220.0, 80.0), 32.0)
	BattleVfx.spawn_lightning_strike(root_node, Vector2(0.0, 0.0), Vector2(70.0, -40.0), Vector2(150.0, 30.0), 1, 0)
	await process_frame
	await process_frame
	...
	BattleVfx.flash_red([player_sprite], 0.08, 0.86)
