...
const MAIN_MENU_SCENE := "res://scenes/ui/screens/main_menu.tscn"
const CHARACTER_SELECT_SCENE := "res://scenes/ui/screens/character_select.tscn"
const GAME_SCENE := "res://scenes/gameplay/game_scene.tscn"
const RESULT_SCENE := "res://scenes/ui/screens/result_screen.tscn"
